    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="traitement_ajouter_produit.php"  id="form-login" method="post" enctype="multipart/form-data">
                <div class="text-center">
                    <h2> AJOUTER UN PRODUIT GAMING SHOP</h2>
               </div>
                <div class="mb-3">
                    <label for="nom_du_produit" class="form-label">Nom du produit</label>
                    <input type="text" class="form-control" id="nom_du_produit" name="nom_du_produit" required>
                </div>
