                    ...
                    <?php
                        foreach ($statement as $produits){
                            ...
                            <div class="col-sm-12 col-lg-4 mt-5">
                                <div class="card">
                                    <div class="text-center">
                                        <h4 class="card-title text-info"><?= $produits['nom_du_produit'] ?></h4>
                                        <img src="<?= $produits['image'] ?>" class="card-img-top img-fluid" alt="<?= $produits['nom_du_produit'] ?>" title="<?= $produits['nom_du_produit'] ?>">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-success fw-bold">PRIX : <?= $produits['prix_produit'] ?> €</p>
